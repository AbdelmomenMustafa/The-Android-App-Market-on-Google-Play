...
apps_with_size_and_rating_present = apps[(pd.notnull(apps["Size"])&(pd.notnull(apps["Rating"])))]

# Subset for categories with at least 250 apps
large_categories = apps_with_size_and_rating_present.groupby(apps_with_size_and_rating_present["Category"]).filter(lambda x: len(x) >= 250)
